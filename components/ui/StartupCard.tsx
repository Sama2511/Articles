      ...
      <div className="flex justify-between items-center mt-5 gap-5">
        <div className="flex-1">
          <Link href={`/user/${authorId}`}>
            <p className="font-medium text-[16px] text-black truncate">{name}</p>
          </Link>
        ...
        <Link href={`/startup/${_id}`}>
            ...
            <Image src={image} alt='placeholder' className="w-full h-[164px] rounded-[10px] object-cover" width={400} height={400}/>
        </Link>
